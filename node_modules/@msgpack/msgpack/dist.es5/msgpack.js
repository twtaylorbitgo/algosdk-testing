...
var wm = (function () {
    ...
    try {
        return __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module '../dist/wasm/msgpack.wasm.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
    }
    catch (e) {
        if (FORCE_WASM) {
            throw e;
