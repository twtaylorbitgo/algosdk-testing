(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("base64-js"));
	else if(typeof define === 'function' && define.amd)
		define([], factory);
	else if(typeof exports === 'object')
		exports["MessagePack"] = factory(require("base64-js"));
	else
		root["MessagePack"] = factory(root[undefined]);
...
var wasmModule = new WebAssembly.Module(
  base64.toByteArray("")
);
...
var TEXT_DECODER_THRESHOLD = null !== "force" ? 200 : 0;
...
// CONCATENATED MODULE: ./src/wasmFunctions.ts
// WASM=never - disable WASM functions
// WASM=force - force to use WASM functions
var WASM =  false || "";
var NO_WASM = WASM === "never";
var FORCE_WASM = WASM === "force";
...
var WASM_AVAILABLE = !!wm;
// A hint of when to use WASM ver.
var WASM_STR_THRESHOLD = FORCE_WASM ? 0 : 1024;
function setMemoryU8(destPtr, src, size) {
    var destView = new Uint8Array(wm.memory.buffer, destPtr, size);
    destView.set(src);
}
function setMemoryStr(destPtr, destByteLength, str, strLength) {
    var inputView = new DataView(wm.memory.buffer, destPtr, destByteLength);
...
function utf8EncodeWasm(str, output, outputOffset) {
    var strLength = str.length;
    var inputByteLength = strLength * 2;
    var inputU16BePtr = wm.malloc(inputByteLength);
    setMemoryStr(inputU16BePtr, inputByteLength, str, strLength);
    var maxOutputHeaderSize = 1 + 4; // headByte + u32
    var outputPtr = wm.malloc(maxOutputHeaderSize + strLength * 4);
    try {
        var outputLength = wm.utf8EncodeUint16Array(outputPtr, inputU16BePtr, strLength);
...
var wasmFunctions_CHUNK_SIZE = 65536;
function safeStringFromCharCodeU16(units) {
    if (units.length <= wasmFunctions_CHUNK_SIZE) {
    ...
    for (var i = 0; i < units.length; i++) {
        var chunk = units.subarray(i * wasmFunctions_CHUNK_SIZE, (i + 1) * wasmFunctions_CHUNK_SIZE);
...
function utf8DecodeWasm(bytes, inputOffset, byteLength) {
    var inputPtr = wm.malloc(byteLength);
    // in worst case, the UTF-16 array uses the same as byteLength * 2
    var outputPtr = wm.malloc(byteLength * 2);
    try {
        setMemoryU8(inputPtr, bytes.subarray(inputOffset, inputOffset + byteLength), byteLength);
        var outputArraySize = wm.utf8DecodeToUint16Array(outputPtr, inputPtr, byteLength);
        var units = new Uint16Array(wm.memory.buffer, outputPtr, outputArraySize);
...
var Encoder_Encoder = /** @class */ (function () {
    function Encoder(extensionCodec, maxDepth, initialBufferSize, sortKeys, forceFloat32) {
...
function encode(value, options) {
    ...
    var encoder = new Encoder_Encoder(options.extensionCodec, options.maxDepth, options.initialBufferSize, options.sortKeys, options.forceFloat32);
...
var Decoder_Decoder = /** @class */ (function () {
    function Decoder(extensionCodec, maxStrLength, maxBinLength, maxArrayLength, maxMapLength, maxExtLength, cachedKeyDecoder) {
        if (extensionCodec === void 0) { extensionCodec = ExtensionCodec_ExtensionCodec.defaultCodec; }
    ...
    Decoder.prototype.decodeSync = function () {
        DECODE: while (true) {
            ...
            while (stack.length > 0) {
                ...
                else if (state.type === 2 /* MAP_VALUE */) {
                    // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
...
function decode(buffer, options) {
    ...
    var decoder = new Decoder_Decoder(options.extensionCodec, options.maxStrLength, options.maxBinLength, options.maxArrayLength, options.maxMapLength, options.maxExtLength);
...
var defaultDecodeAsyncOptions = defaultDecodeOptions;
function decodeAsync(streamLike, options) {
    ...
    return decodeAsync_awaiter(this, void 0, void 0, function () {
        ...
        return decodeAsync_generator(this, function (_a) {
            ...
            decoder = new Decoder_Decoder(options.extensionCodec, options.maxStrLength, options.maxBinLength, options.maxArrayLength, options.maxMapLength, options.maxExtLength);
...
/* concated harmony reexport __WASM_AVAILABLE */__webpack_require__.d(__webpack_exports__, "__WASM_AVAILABLE", function() { return WASM_AVAILABLE; });
// Main Functions:
...
//# sourceMappingURL=msgpack+wasm.js.map