...
class Decoder {
    constructor(extensionCodec = ExtensionCodec_1.ExtensionCodec.defaultCodec, maxStrLength = DEFAULT_MAX_LENGTH, maxBinLength = DEFAULT_MAX_LENGTH, maxArrayLength = DEFAULT_MAX_LENGTH, maxMapLength = DEFAULT_MAX_LENGTH, maxExtLength = DEFAULT_MAX_LENGTH, cachedKeyDecoder = sharedCachedKeyDecoder) {
    ...
    decodeUtf8String(byteLength, headerOffset) {
        ...
        else if (wasmFunctions_1.WASM_AVAILABLE && byteLength > wasmFunctions_1.WASM_STR_THRESHOLD) {
            object = wasmFunctions_1.utf8DecodeWasm(this.bytes, offset, byteLength);
        }
        else {
